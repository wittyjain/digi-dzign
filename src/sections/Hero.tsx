...
export default function Hero() {
  const beforeElement =
    "before:block before:w-32 before:h-32 before:bg-hero-cyan before:bg-cover before:bg-no-repeat before:absolute before:top-0 before:left-48 before:rotate-3";
  const afterElement =
